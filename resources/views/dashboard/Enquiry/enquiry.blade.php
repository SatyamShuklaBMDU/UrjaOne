                        ...
                        <tbody>
                            @foreach ($enquiries as $enquiry)
                                <tr data-enquiry-id="{{ $enquiry->id }}">
                                    ...
                                    <td style="text-align: center;" class="text-ov">{{ $enquiry->plant_load }}
                                        <strong>(KW)</strong>
                                    </td>
                                    <td style="text-align: center;">{{$enquiry->total_quotation??'--'}}</td>
                                    <td style="text-align: center;">
                                        <div class="d-flex">
                                            <div class="view-more-btn"><i style="color:blue;padding-right: 10px;margin-top:10px;cursor: pointer;" class="fas fa-eye" onclick="fetchEnquiryDetails({{ $enquiry->id }})"></i></div>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
