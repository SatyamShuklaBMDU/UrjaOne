                            ...
                            <tbody>
                                @foreach ($walletHistory as $plan)
                                    <tr data-plan-id="{{ $plan->id }}">
                                        ...
                                        <td style="text-align: center;">{{ $plan->userdetails->state??'--' }}</td>
                                        <td style="text-align: center;">{{ $plan->userdetails->city??'--' }}</td>
                                        <td style="text-align: center;"><a class="btn btn-primary" style="padding: 0.375rem 0.75rem;border-radius: 0.75rem;font-size: 0.875rem;" href="{{route('detailed-wallet-statement',encrypt($plan->userdetails->id))}}" role="button" >View</a></td>
                                        <td style="text-align: center;"><a class="btn btn-primary" style="padding: 0.375rem 0.75rem;border-radius: 0.75rem;font-size: 0.875rem;" href="{{route('detailed-wallet-transaction',encrypt($plan->userdetails->id))}}" role="button" >View</a></td>
                                        {{-- <td style="text-align: center;">
