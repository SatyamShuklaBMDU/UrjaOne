            ...
            <div class="col-md-12 d-flex">
                <div class="col-md-3">
                    <div class="align-items-center">
                        <a href="{{ route('user-banner', 'Home') }}" class="btn btn-primary mb-2 btn-rounded"><span
                                class="text-white fw-bold"> Home Banner</span></a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="align-items-center">
                        <a href="{{ route('user-banner', 'About') }}" class="btn btn-primary mb-2 btn-rounded"><span
                                class="text-white fw-bold"> About Banner</span></a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="align-items-center">
                        {{-- <a href="{{ route('user-banner', 'Blog') }}" class="btn btn-primary mb-2 btn-rounded"><span
