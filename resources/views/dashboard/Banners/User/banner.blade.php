                                    ...
                                    <tr data-banner-id="{{ $user->id }}">
                                        ...
                                        <td>
                                            <select class="form-select border-dark fw-bold statusSwitch" style="width:100px;">
                                                <option value="1" {{ $user->status == '1' ? 'selected' : '' }} class="bg-success text-light">Active</option>
                                                <option value="0" {{ $user->status == '0' ? 'selected' : '' }} class="bg-danger text-light">Deactive</option>
                                            </select>
                                        </td>
                                        <td>
                                            <div class="d-flex">
