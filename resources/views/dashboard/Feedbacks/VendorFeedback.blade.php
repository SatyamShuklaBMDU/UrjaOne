...
@section('content')
    <div class="mt-5 mb-sm-4 d-flex flex-wrap align-items-center text-head">
        <h2 class="mb-3 me-auto">Vendor Feedback</h2>
            ...
            <div class="col-md-7">
                <div class=" align-items-center">
                    <div id="datePickerContainer">
                        <form action="{{ route('filter-vendor-feedback') }}" method="post">
                            @csrf
                            <div>
                            ...
                            <tbody>
                                @foreach ($vendorFeedback as $uf)
                                    <tr data-feedback-id="{{ $uf->id }}">
                                        ...
                                        <td style="text-align: center;">{{ $uf->vendor->cin_no }}</td>
                                        <td style="text-align: center;">{{ $uf->vendor->phone_number }}</td>
                                        <td style="text-align: center;">{{ $uf->vendor->name }}</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sendReply').click(function() {
                ...
                $.ajax({
                    url: "{{ route('vendorreplyTofeedback') }}",
                    type: "POST",
                    data: {
